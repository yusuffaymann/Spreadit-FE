...
function ModCommunityRightSidebar() {
    ...
    const [communityDescription, setcommunityDescription] = useState("Comunitydescription");
    ...
    const [widgetDescription, setWidgetDescription] = useState("widgetDescription");
  ...
  return(
    <div className={styles.sidebar}>
        ...
        <ModeEditOutlineTwoToneIcon className={styles.editbutton} onClick={()=>EditCommunity()}/>
        </div>
       ...
       <br></br>
        ...
        <button className={styles.bookmarksbuttons} style={{ backgroundColor: "rgb(48, 52, 206)", color:"white" }}>Edit Widgets</button>

        <br></br>
        <br></br>
        <br></br>

     {showEditCommunityModal && <EditCommunityModal close={()=>CloseEditCommunity()} /> }
